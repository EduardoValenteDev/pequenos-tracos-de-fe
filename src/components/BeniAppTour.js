...
const INITIAL_STEPS = [
  { variant: 'happy',       title: 'Eu sou o Beni!',   text: 'Vou caminhar com você pelas histórias da Bíblia.' },
  { variant: 'celebrating', title: 'Comece pelo brilho', text: 'Quando um ponto brilhar, toque nele para continuar.' },
];
