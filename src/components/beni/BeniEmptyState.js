...
/**
 * BeniEmptyState — estado vazio com Beni.
 ...
 * @param {object}   [style]
 */
export default function BeniEmptyState({ title, message, actionLabel, onPress, style }) {
  return (
    <View style={[styles.container, style]}>
      <BeniAvatar variant="thinking" size="large" style={styles.avatar} />
