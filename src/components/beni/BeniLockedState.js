...
/**
 * BeniLockedState — estado de conteúdo premium bloqueado com Beni.
 ...
 * @param {object}   [style]
 */
export default function BeniLockedState({
  ...
  return (
    <View style={[styles.container, style]}>
      <BeniAvatar variant="locked" size="large" style={styles.avatar} />
