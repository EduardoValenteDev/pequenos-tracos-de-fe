...
export default function BeniGuideOverlay({
  ...
  const TAB_INDEX_BY_KEY = { home: 0, adventures: 1, atelier: 2, stars: 3 };
  const SIDEBAR_TARGET_BY_KEY = { home: 'home.sidebarTab', adventures: 'adventures.sidebarTab', atelier: 'atelier.sidebarTab', stars: 'stars.sidebarTab' };
  const targetFor = (s) =>
