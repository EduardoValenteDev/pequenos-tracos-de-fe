...
export const STORY_COVERS = {
  ...
  noah:                 require('../../assets/images/noe_cover.webp'),
  david_goliath:        require('../../assets/images/david_goliath_cover.webp'),
  jesus_children:       require('../../assets/images/jesus_children_cover.webp'),
  daniel_lions:         require('../../assets/images/daniel_leoes_cover.webp'),
  jonah_big_fish:       require('../../assets/images/jonas_peixe_cover.webp'),
  lost_sheep:           require('../../assets/images/ovelha_perdida_cover.webp'),
  good_samaritan:       require('../../assets/images/bom_samaritano_cover.webp'),
  abraham_stars:        require('../../assets/images/abraao_estrelas_cover.webp'),
  joseph_colorful_coat: require('../../assets/images/jose_tunica_cover.webp'),
  moses_red_sea:        require('../../assets/images/moises_mar_vermelho_cover.webp'),
  ruth_naomi:           require('../../assets/images/rute_noemi_cover.webp'),
  esther_queen:         require('../../assets/images/ester_rainha_cover.webp'),
  miraculous_catch:     require('../../assets/images/pesca_milagrosa_cover.webp'),
  samuel_hears_god:     require('../../assets/images/samuel_ouve_cover.webp'),
  josiah_young_king:    require('../../assets/images/josias_rei_jovem_cover.webp'),
  solomon_wisdom:       require('../../assets/images/salomao_sabedoria_cover.webp'),
  mary_says_yes:        require('../../assets/images/maria_boa_noticia_cover.webp'),
  timothy_faith:        require('../../assets/images/timoteo_fe_cover.webp'),
  jesus_temple:         require('../../assets/images/jesus_templo_cover.webp'),
};
