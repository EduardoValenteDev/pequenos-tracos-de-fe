...
export const QUIZZES = {
  ...
  noah: [
    ...
    { id: 'noah_q4', question: 'O que apareceu no céu depois da chuva?', options: ['Um arco-íris', 'Uma escada', 'Uma estrela gigante'], correct: 0 },
    ...
    { id: 'noah_q8', question: 'O que a pombinha trouxe de volta no bico?', options: ['Um ramo de oliveira', 'Um peixe', 'Uma pedra'], correct: 0 },
  ],
  ...
  david_goliath: [
    ...
    { id: 'david_q7', question: 'Por quantos dias Golias fez o desafio ao exército de Israel?', options: ['Quarenta dias', 'Sete dias', 'Um dia'], correct: 0 },
  ...
  jonah_big_fish: [
    ...
    { id: 'jonah_q6', question: 'O que o peixe fez com Jonas depois de três dias?', options: ['O cuspiu na praia', 'O levou para o fundo do mar', 'O engoliu de novo'], correct: 0 },
  ...
  good_samaritan: [
    ...
    { id: 'samaritan_q3', question: 'O que Jesus disse ao fim da história?', options: ['"Vai e faz o mesmo"', '"Não se envolva com os problemas dos outros"', '"Cuide só da sua família"'], correct: 0 },
  ...
  abraham_stars: [
    ...
    { id: 'abraham_q5', question: 'O que aconteceu com Abraão antes de Deus falar mais sobre o futuro?', options: ['Um sono profundo e especial caiu sobre ele', 'Ele subiu numa montanha alta', 'Uma luz muito forte o cegou'], correct: 0 },
    { id: 'abraham_q6', question: 'Quem passou sozinho entre os animais para selar a aliança?', options: ['Uma tocha de fogo — que era Deus', 'Abraão com seu cajado', 'Um anjo enviado por Deus'], correct: 0 },
  ...
  joseph_colorful_coat: [
    { id: 'joseph_q1', question: 'O que o pai de José lhe deu como presente especial?', options: ['Um manto de muitas cores', 'Uma coroa dourada', 'Um cajado de prata'], correct: 0 },
  ...
  moses_red_sea: [
    ...
    { id: 'moses_q4', question: 'O que Deus colocou entre Israel e o exército egípcio durante a noite?', options: ['A coluna de nuvem e fogo', 'Uma muralha de pedras', 'Um rio profundo'], correct: 0 },
    ...
    { id: 'moses_q7', question: 'O que aconteceu com as rodas dos carros egípcios no leito do mar?', options: ['Ficaram presas na areia molhada', 'Quebraram na rocha', 'Afundaram na lama'], correct: 0 },
  ...
  esther_queen: [
    { id: 'esther_q1', question: 'Como Ester se tornou rainha da Pérsia?', options: ['O rei Assuero a escolheu entre todas as moças do reino', 'Ela conquistou o trono com seu exército', 'O povo judeu a indicou para o rei'], correct: 0 },
    ...
    { id: 'esther_q5', question: 'O que Ester disse antes de ir ao rei, mostrando sua coragem?', options: ['"Se eu perecer, pereço — mas vou ao rei"', '"Tenho certeza que vai dar certo"', '"Farei isso apenas se for seguro"'], correct: 0 },
    { id: 'esther_q6', question: 'O que o rei fez quando viu Ester entrar sem ser chamada?', options: ['Estendeu o cetro dourado para recebê-la', 'Ficou muito bravo com ela', 'Mandou os guardas a prender'], correct: 0 },
  ...
  samuel_hears_god: [
    ...
    { id: 'samuel_q2', question: 'Onde Samuel estava quando ouviu a voz de Deus?', options: ['Dormindo no templo perto da arca', 'No campo ao amanhecer', 'Em casa com sua mãe Ana'], correct: 0 },
    ...
    { id: 'samuel_q7', question: 'O que Eli disse ao ouvir a mensagem de Deus?', options: ['"É o Senhor — que Ele faça o que lhe parecer bom"', '"Essa mensagem não é de Deus"', '"Não conte a mais ninguém"'], correct: 0 },
  ...
  josiah_young_king: [
    { id: 'josiah_q1', question: 'Com quantos anos Josias se tornou rei?', options: ['Oito anos', 'Doze anos', 'Dezesseis anos'], correct: 0 },
    ...
    { id: 'josiah_q5', question: 'Como Josias reagiu quando a lei foi lida para ele?', options: ['Rasgou as roupas em sinal de arrependimento', 'Ficou animado e festejou', 'Mandou guardar o livro na biblioteca'], correct: 0 },
    { id: 'josiah_q6', question: 'Quem Josias mandou consultar para saber o que Deus dizia?', options: ['A profetisa Hulda', 'O sumo sacerdote Hilquias', 'O profeta Isaías'], correct: 0 },
  ...
  solomon_wisdom: [
    ...
    { id: 'solomon_q3', question: 'Como Salomão descreveu sua própria fragilidade diante de Deus?', options: ['Como uma criança que não sabe entrar nem sair sozinha', 'Como alguém que sabe o que faz', 'Como o mais preparado para reinar'], correct: 0 },
  ...
  timothy_faith: [
    { id: 'timothy_q1', question: 'Onde Timóteo cresceu?', options: ['Na cidade de Listra', 'Em Jerusalém', 'Em Roma'], correct: 0 },
    ...
    { id: 'timothy_q6', question: 'O que Timóteo decidiu quando Paulo o chamou?', options: ['Deixou Listra e foi com Paulo na missão', 'Ficou para cuidar da mãe e da avó', 'Pediu mais tempo para decidir'], correct: 0 },
    { id: 'timothy_q7', question: 'O que Paulo disse a Timóteo para fazer com seus dons?', options: ['"Avive a chama do dom que Deus te deu"', '"Esconda até estar mais preparado"', '"Compartilhe apenas com pessoas de confiança"'], correct: 0 },
  ...
  jesus_temple: [
    ...
    { id: 'temple_q7', question: 'O que Jesus respondeu a seus pais?', options: ['"Não sabiam que eu devia estar nos negócios de meu Pai?"', '"Estava apenas estudando com os doutores"', '"Perdi a hora de voltar — desculpem"'], correct: 0 },
