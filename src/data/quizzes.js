...
export const QUIZZES = {
  ...
  daniel_lions: [
    ...
    { id: 'daniel_q4', question: 'Por quantos dias a lei injusta proibia fazer pedidos a Deus?', options: ['Trinta dias', 'Sete dias', 'Cem dias'], correct: 0 },
    ...
    { id: 'daniel_q6', question: 'Como Daniel saiu da cova dos leões?', options: ['Sem nenhum ferimento', 'Com alguns machucados', 'Ajudado pelos soldados do rei'], correct: 0 },
    { id: 'daniel_q7', question: 'O que o rei Dario reconheceu depois de ver Daniel livre?', options: ['Que o Deus de Daniel é vivo e poderoso', 'Que Daniel era o novo rei', 'Que os leões seriam soltos'], correct: 0 },
  ...
  jonah_big_fish: [
    ...
    { id: 'jonah_q4', question: 'O que Jonas fez em vez de obedecer a Deus?', options: ['Entrou num navio em direção oposta ao chamado de Deus', 'Foi direto para Nínive', 'Ficou parado sem fazer nada'], correct: 0 },
  ...
  abraham_stars: [
    { id: 'abraham_q1', question: 'O que Deus disse a Abraão logo no início da visão?', options: ['Que Ele era seu escudo e sua recompensa', '"Você deve construir um altar"', '"Saia desta terra agora"'], correct: 0 },
    ...
    { id: 'abraham_q6', question: 'O que Deus prometeu a Abrão, além de uma descendência numerosa?', options: ['Uma terra', 'Um grande exército', 'Uma cidade murada'], correct: 0 },
    { id: 'abraham_q7', question: 'O que as estrelas lembravam a Abrão?', options: ['Que Deus é fiel', 'Que ele deveria partir depressa', 'Que a promessa havia falhado'], correct: 0 },
  ...
  joseph_colorful_coat: [
    ...
    { id: 'joseph_q3', question: 'O que os irmãos de José fizeram com ele por ciúmes?', options: ['Venderam-no a mercadores', 'Esconderam ele numa floresta', 'Mandaram ele para longe da família'], correct: 0 },
    ...
    { id: 'joseph_q5', question: 'O que Jacó fez ao ouvir os sonhos de José?', options: ['Guardou aquilo no coração', 'Ficou com raiva de José', 'Mandou José para longe'], correct: 0 },
    { id: 'joseph_q6', question: 'Para onde José foi levado depois de ser vendido?', options: ['Para o Egito, longe de sua família', 'Para Belém', 'Para o deserto de Sinai'], correct: 0 },
    { id: 'joseph_q7', question: 'O que José disse aos irmãos quando os perdoou?', options: ['Deus usou sua história para preservar vidas', 'Vocês ainda vão me pagar', 'Nunca mais nos veremos'], correct: 0 },
  ...
  moses_red_sea: [
    ...
    { id: 'moses_q2', question: 'O que havia atrás do povo quando chegaram ao mar?', options: ['O perigo do Egito', 'Uma cidade em festa', 'Um rio calmo'], correct: 0 },
    { id: 'moses_q3', question: 'Como o povo saiu do Egito em direção à liberdade?', options: ['Famílias caminharam juntas pelo deserto', 'Cada um partiu sozinho', 'Foram levados em carruagens'], correct: 0 },
    { id: 'moses_q4', question: 'O que Deus colocou entre o povo e o perigo?', options: ['A coluna de nuvem', 'Uma muralha de pedras', 'Um rio profundo'], correct: 0 },
    ...
    { id: 'moses_q6', question: 'Como Israel atravessou o Mar Vermelho?', options: ['Em terra seca, com as águas como muros dos dois lados', 'Num barco especial', 'Nadando com ajuda dos anjos'], correct: 0 },
    { id: 'moses_q7', question: 'O que aconteceu quando Moisés estendeu a mão sobre o mar?', options: ['Um forte vento soprou e as águas se dividiram', 'Choveu durante quarenta dias', 'O mar ficou parado e escuro'], correct: 0 },
  ...
  ruth_naomi: [
    ...
    { id: 'ruth_q3', question: 'O que Rute disse quando Noemi quis que ela voltasse?', options: ['Que o povo e o Deus de Noemi seriam os seus', '"Vou ir embora mas voltarei"', '"Preciso cuidar da minha família primeiro"'], correct: 0 },
    { id: 'ruth_q4', question: 'O que Rute fez para cuidar de si e de Noemi em Belém?', options: ['Foi ao campo recolher espigas deixadas para os pobres', 'Trabalhou como costureira', 'Vendeu as joias que tinha'], correct: 0 },
    ...
    { id: 'ruth_q6', question: 'Por que Boaz tratou Rute com tanta bondade?', options: ['Porque soube da fidelidade dela com Noemi', 'Porque ela era muito bonita', 'Porque o rei mandou cuidar dela'], correct: 0 },
    { id: 'ruth_q7', question: 'Quem nasceu de Rute e Boaz?', options: ['Obede', 'Samuel', 'Josias'], correct: 0 },
    { id: 'ruth_q8', question: 'O que a história de Rute nos ensina?', options: ['A fidelidade e a bondade abrem caminhos que só Deus pode abrir', 'Devemos sempre ficar com nossa própria família', 'A vida é fácil para quem é fiel'], correct: 0 },
  ],
  ...
  miraculous_catch: [
    ...
    { id: 'miraculous_q2', question: 'O que Jesus pediu a Pedro para poder ensinar a multidão?', options: ['Que afastasse um pouco o barco da terra', 'Que levasse pessoas até Ele', 'Que preparasse comida para todos'], correct: 0 },
    { id: 'miraculous_q3', question: 'O que Jesus mandou Pedro fazer depois de ensinar?', options: ['Levar o barco para águas mais profundas e lançar as redes', 'Voltar para casa descansar', 'Distribuir peixe para o povo'], correct: 0 },
    { id: 'miraculous_q4', question: 'O que Simão decidiu, mesmo tendo trabalhado a noite toda?', options: ['Obedecer à palavra de Jesus', 'Ir descansar em casa', 'Pedir um barco maior'], correct: 0 },
    { id: 'miraculous_q5', question: 'O que aconteceu quando Pedro lançou as redes?', options: ['Pegaram tantos peixes que as redes começaram a se encher muito', 'Vieram alguns peixes pequenos', 'As redes quebraram na corrente'], correct: 0 },
    { id: 'miraculous_q6', question: 'O que Pedro fez ao ver o milagre?', options: ['Reconheceu que estava diante de alguém santo e se sentiu pequeno', 'Correu para contar a todos os pescadores', 'Ficou olhando sem reação'], correct: 0 },
    { id: 'miraculous_q7', question: 'O que Jesus disse a Pedro depois do milagre?', options: ['Que não tivesse medo, pois seria chamado para alcançar pessoas', '"Continue pescando que você é muito bom"', '"Vá vender esses peixes no mercado"'], correct: 0 },
  ...
  samuel_hears_god: [
    { id: 'samuel_q1', question: 'O que Samuel fazia no tabernáculo?', options: ['Servia a Deus com o sacerdote Eli', 'Pastoreava ovelhas perto do templo', 'Ensinava as crianças do povo'], correct: 0 },
    ...
    { id: 'samuel_q3', question: 'Quem Samuel pensou que o havia chamado?', options: ['O sacerdote Eli', 'Sua mãe', 'Um dos soldados'], correct: 0 },
    { id: 'samuel_q4', question: 'O que Eli ensinou Samuel a dizer quando ouvisse a voz?', options: ['"Fala, Senhor, porque o teu servo ouve"', '"Estou aqui, pode continuar"', '"Vou ouvir se você se identificar"'], correct: 0 },
    { id: 'samuel_q5', question: 'O que Deus falou a Samuel naquela noite?', options: ['Uma mensagem séria', 'Que Samuel seria rei de Israel', 'Que o templo seria destruído em breve'], correct: 0 },
    ...
    { id: 'samuel_q7', question: 'O que Eli pediu quando Samuel teve receio de contar?', options: ['Que Samuel falasse tudo', 'Que Samuel guardasse segredo', 'Que Samuel voltasse a dormir'], correct: 0 },
  ...
  josiah_young_king: [
    ...
    { id: 'josiah_q8', question: 'O que a Bíblia diz sobre Josias?', options: ['Que ele fez o que era reto aos olhos do Senhor', 'Ele foi o mais rico entre todos os reis', 'Ele foi o rei que mais guerras venceu'], correct: 0 },
  ],
  ...
  mary_says_yes: [
    { id: 'mary_q1', question: 'Quem era Maria e onde ela morava?', options: ['Uma jovem simples de Nazaré', 'Uma princesa de Jerusalém', 'Uma sacerdotisa do templo'], correct: 0 },
    ...
    { id: 'mary_q3', question: 'Como o anjo cumprimentou Maria?', options: ['Saudou-a e disse que o Senhor era com ela', '"Você foi escolhida para uma missão perigosa"', '"Escute — tenho um recado urgente"'], correct: 0 },
    { id: 'mary_q4', question: 'O que o anjo disse para tranquilizar Maria?', options: ['Que não precisava ter medo, pois havia encontrado graça diante de Deus', '"Tudo ficará bem no final"', '"Não precisa fazer nada difícil"'], correct: 0 },
    { id: 'mary_q5', question: 'O que o anjo anunciou a Maria?', options: ['Que teria um filho chamado Jesus, o Filho do Altíssimo', 'Que ela seria a rainha de Israel', 'Que ela receberia um grande tesouro'], correct: 0 },
    { id: 'mary_q6', question: 'O que Maria perguntou ao anjo?', options: ['Como aquilo aconteceria', '"Por que eu fui escolhida?"', '"Quando isso vai acontecer?"'], correct: 0 },
    { id: 'mary_q7', question: 'O que o anjo disse para explicar como seria possível?', options: ['Que o poder de Deus realizaria o que parecia impossível', 'Seria um milagre misterioso que ela não precisava entender', 'Um anjo ajudaria a cuidar da criança'], correct: 0 },
    { id: 'mary_q8', question: 'O que Maria respondeu ao anjo?', options: ['Chamou-se serva do Senhor e aceitou que a palavra de Deus se cumprisse', '"Preciso pensar mais antes de decidir"', '"Vou conversar com José primeiro"'], correct: 0 },
  ],
  ...
  timothy_faith: [
    ...
    { id: 'timothy_q4', question: 'Desde quando Timóteo conhecia as Sagradas Escrituras?', options: ['Desde menino', 'Desde que Paulo chegou a Listra', 'A partir dos doze anos'], correct: 0 },
    ...
    { id: 'timothy_q6', question: 'O que Timóteo se tornou junto do apóstolo Paulo?', options: ['Caminhou ao lado de Paulo, servindo as igrejas', 'Alguém que recusou o chamado', 'Um soldado do exército romano'], correct: 0 },
    { id: 'timothy_q7', question: 'O que Paulo disse que Timóteo deveria ser, mesmo sendo jovem?', options: ['Um exemplo na fé, no amor e no cuidado', 'Um soldado forte e temido', 'Alguém que esconde sua fé'], correct: 0 },
  ...
  jesus_temple: [
    ...
    { id: 'temple_q7', question: 'O que Jesus respondeu a seus pais?', options: ['Que precisava estar nas coisas de seu Pai', '"Estava apenas estudando com os doutores"', '"Perdi a hora de voltar — desculpem"'], correct: 0 },
