...
> **Atualizado nas Fases 4A, 4B, 4C e 4D (Product Lock).**
> **Versão 5 — matriz única, deduplicada, definitiva e canônica.**

| Campo | Valor |
|---|---|
| **Estado** | **CANÔNICA — ADOTADA PELOS DOCUMENTOS ÁRBITROS EM E018, ATUALIZADA PELAS FASES 4A, 4B, 4C E 4D** |
| **Base auditada** | E009 a E015, mais os sete riscos `R` residuais absorvidos em E018, mais as decisões do fundador registradas nas Fases 4A, 4B, 4C e 4D |
| **Branch auditada** | `integrate/colorir-canonical-runtime` |
| **HEAD canônico** | `015c438106538595b592981fbe1b80b1d5d65e55` |
| **Total de riscos** | **148** — `P-01` a `P-131` (herdados) + `P-132` a `P-134` (E016, ETAPA 4) + `P-135` a `P-139` (E018, ETAPA 2) + `P-140` (Fase 4A, §24) + `P-141` a `P-148` (Fase 4D, §27) |
| **Fusões realizadas** | **0** |
...
| Product Lock | Riscos |
|---|---|
| `INFORMA O PRODUCT LOCK` | 89 |
| `NÃO BLOQUEIA PRODUCT LOCK` | 42 |
| `EXIGE DECISÃO NO PRODUCT LOCK` | 17 |
...
| `EXIGE DECISÃO NO PRODUCT LOCK` | 17 | `P-02` · `P-09` · `P-16` · `P-37` · `P-43` · `P-45` · `P-75` · `P-76` · `P-85` · `P-100` · `P-108` · `P-121` · `P-122` · `P-123` · `P-132` · `P-133` · `P-135` |
| `EXIGE VALIDAÇÃO FÍSICA` (status) | 10 | `P-06` · `P-20` · `P-21` · `P-27` · `P-28` · `P-31` · `P-35` · `P-127` · `P-128` · `P-129` |
| `DECISÃO DE PRODUTO PENDENTE` | 9 | `P-02` · `P-45` · `P-75` · `P-76` · `P-85` · `P-100` · `P-121` · `P-122` · `P-135` |
